...
Інший спосіб відстеження метрик з додатків, це використання OpenTelemetry Instrumentation. Це можна зробити за допомогою OpenTelemetry Operator, який встановлюється в кластері kind.
...
Використання анотації `sidecar.opentelemetry.io/inject: "monitoring/opentelemetry-sidecar"` призведе до додавання контейнера колектора до пода kbot.
...
![](assets/prometheus_kbot_signals.png) | ![](assets/loki_kbot_signals.png)
--|--
